...
#
# Generated by export_simulation on Thu May 28 17:18:30 +0800 2020
#
################################################################################
...
switch to the './control_memory.sh' script.

./control_memory.sh -reset_run
...
./control_memory.sh -noclean_files

For more information on the script, please type './control_memory.sh -help'.
