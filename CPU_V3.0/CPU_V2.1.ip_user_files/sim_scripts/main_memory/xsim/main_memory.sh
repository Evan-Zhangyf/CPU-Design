...
#
# Generated by Vivado on Thu May 28 17:31:02 +0800 2020
...
# Script info
echo -e "main_memory.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot main_memory xil_defaultlib.main_memory -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim main_memory -key {Behavioral:sim_1:Functional:main_memory} -tclbatch cmd.tcl -log simulate.log
}
