...
HD_PWD='E:/COA experiments/exam 2/CPU_V2.1/CPU_V2.1.runs/control_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_memory.tcl
